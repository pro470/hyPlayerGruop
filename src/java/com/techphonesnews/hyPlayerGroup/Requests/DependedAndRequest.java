...
public final class DependedAndRequest implements PlayerGroupGroupChangeRequest {
    ...
    public DependedAndRequest(Collection<? extends PlayerGroupGroupChangeRequest> dependencies, PlayerGroupGroupChangeRequest request) {
    ...
    public String debugMessage() {
        return request.debugMessage() + " \nAnd Depended on: " + dependencies.stream().map(PlayerGroupGroupChangeRequest::debugMessage).collect(Collectors.joining(", "));
    }
